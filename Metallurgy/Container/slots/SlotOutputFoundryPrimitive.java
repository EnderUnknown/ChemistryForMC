...
public class SlotOutputFoundryPrimitive extends Slot
{
    private final EntityPlayer player;
    private int removeCount;

    public SlotOutputFoundryPrimitive(EntityPlayer player, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
    ...
    protected void onCrafting(ItemStack stack)
    {
        ...
        if (!this.player.world.isRemote)
        {
            ...
            float f = FoundryRecipes.instance().getFoundryExperience(stack);
